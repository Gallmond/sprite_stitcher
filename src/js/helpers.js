class helpers {
	...
	static colourDistance(rgb_arr_1, rgb_arr_2, method = 0) {
		...
		if (method === 0) { // Euclidean
		...
		} else if (method === 1) { // CIE76

		} else if (method === 2) { // CIE94
			// https://stackoverflow.com/a/52453462/2244284
			let labA = helpers.rgb2lab(rgb_arr_1);
			let labB = helpers.rgb2lab(rgb_arr_2);
			...
			distance = i < 0 ? 0 : Math.sqrt(i);
		} else if (method === 3) { // CIEDE2000
		} else if (method === 4) { // CMC l:c (1984)
		}
		return distance;
	}
